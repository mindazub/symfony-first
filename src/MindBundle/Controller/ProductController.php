...
use MindBundle\Entity\Product;
use MindBundle\Form\ProductType;
...
class ProductController extends Controller
{
    ...
    {
        $product = new Product();
        $form = $this->createForm('MindBundle\Form\ProductType', $product);
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('MindBundle\Form\ProductType', $product);
